...
export function Footer() {
  return (
    <footer className="bg-logistic-900 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300 mb-6">
              Dunyoning istalgan nuqtasiga yuklaringizni tezkor va ishonchli
          ...
          <div>
            <h3 className="text-lg font-semibold mb-6">Foydali havolalar</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-6">Xizmatlar</h3>
            <ul className="space-y-3">
              <li>
                <Link
                  to="/services/local"
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <MapPin className="h-5 w-5 mr-3 mt-0.5 text-orange-500" />
                <span>123 Toshkent sh., Amir Temur ko'chasi</span>
              </li>
